...
const snapshot = JSON.parse(await readFile(new URL('./data/sample-snapshot.json', import.meta.url), 'utf8'));
const ai = {
...
test('diagnosis assembly satisfies the runtime contract', () => {
  const diagnosis = buildDiagnosis(snapshot, { scanId: 'test-scan', generatedAt: '2026-09-01T00:00:00.000Z', ai });
